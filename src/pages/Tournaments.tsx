    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
      ...
      <div className="anim-1">
        {loading ? (
          ...
          <div className="card" style={{ padding: '1.25rem', fontFamily: '"IBM Plex Mono", monospace', fontSize: '0.7rem', color: '#c46060', border: '1px solid #5a1e1e' }}>
            {error}
          </div>
          ...
          <div className="card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '4rem 2rem', gap: '1rem' }}>
            <div style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '4rem', color: '#1e1c18', letterSpacing: '0.05em' }}>TN-00</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1px', background: '#282420' }}>
            {tournaments.map((tournament) => (
              <div key={tournament.id} style={{ background: '#131110', padding: '1.25rem 1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', transition: 'background 0.15s ease' }}
              ...
              >
                <div>
                  ...
                  {tournament.description && (
                    <p style={{ fontFamily: '"Crimson Text", serif', fontSize: '0.9rem', color: '#b0a090', margin: '0 0 0.5rem' }}>{tournament.description}</p>
                  )}
                  <div style={{ display: 'flex', gap: '1.5rem', fontFamily: '"IBM Plex Mono", monospace', fontSize: '0.62rem', letterSpacing: '0.1em', color: '#9a8e7e' }}>
